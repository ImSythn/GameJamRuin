...
private:
	...
	TMap<TEnumAsByte<EPhysicalSurface>, TSubclassOf<URuinMoveStepSound>> MoveStepSounds;
	...
	URuinCharacterMovementComponent* MovementPtr;
...
#pragma region Mutators
	...
	FORCEINLINE TSubclassOf<URuinMoveStepSound>* GetMoveStepSound(TEnumAsByte<EPhysicalSurface> Surface)
	{
	...
	UFUNCTION(Category = "PB Getters", BlueprintPure) FORCEINLINE URuinCharacterMovementComponent* GetMovementPtr() const
	{
		return MovementPtr;
	};
