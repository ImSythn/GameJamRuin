...
UCLASS()
class RUIN_API URuinCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
private:
	...
	class URuinMoveStepSound* GetMoveStepSoundBySurface(EPhysicalSurface SurfaceType) const;
